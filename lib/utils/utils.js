...
export function someGithubRepositorie() {
  const repoList = [
    {
      linkText: 'Apache Spark',
      link: 'https://github.com/kubernetes/kubernetes',
    },
    {
      linkText: 'Microsoft Visual Studio Code',
      link: 'https://github.com/Microsoft/vscode',
    },
    {
      linkText: 'NixOS Package Collection',
    ...
    {
      linkText: 'Firehol IP Lists',
      link: 'https://github.com/firehol/blocklist-ipsets',
    },
    {
      linkText: 'Red Hat OpenShift',
      link: 'https://github.com/openshift/origin',
    },
    {
      linkText: 'Microsoft Azure Documentation',
      link: 'https://github.com/MicrosoftDocs/azure-docs',
    },
    {
      linkText: 'Saltstack',
    ...
    {
      linkText: 'Symfony, a PHP framework',
      link: 'https://github.com/symfony/symfony',
    },
    {
      linkText: 'Liferay, an enterprise web platform',
      link: 'https://github.com/brianchandotcom/liferay-portal',
    },
    {
      linkText: 'PyTorch',
    ...
    {
      linkText: 'Personal cloud software (ownCloud)',
      link: ' https://github.com/owncloud/core',
    },
  ];
...
export function readUserPosts({ size = 100 }) {
  const posts = Array.from(Array(size).keys()).map(() => ({
    ...
    body: {
      ...
      content: generateLongEnglishText(Math.floor(Math.random() * 10)),
